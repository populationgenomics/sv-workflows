...
def main(snp_vcf_dir, str_vcf_dir):
    ...
    celltypes = 'MAIT,B_memory,CD4_CTL,CD4_Proliferating,CD8_Proliferating'
    #,,HSPC,NK_Proliferating,cDC2,CD16_Mono,Treg,CD14_Mono,CD8_TCM,CD4_TEM,CD8_Naive,CD4_TCM,NK,CD8_TEM,CD4_Naive,B_naive'
