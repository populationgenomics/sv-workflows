...
for cell in cell_type_list:
    ...
    def parse_susie(cell):
        ...
        files_list = list(to_path(f'gs://cpg-tenk10k-test-analysis/str/associatr/final_freeze/fine_mapping/susie_summstats/{cell}').rglob('*.tsv'))
        dfs = []
        ...
        result_df.to_csv(f'gs://cpg-tenk10k-test-analysis/str/associatr/final_freeze/fine_mapping/susie_summstats/{cell}/all_genes.csv', index=False)
