...
analysis-runner --dataset tenk10k --access-level test --description "Cell type spec" --output-dir str/cell-spec-cuomo/cell_spec_results master_cell_spec_runner.py
"""
...
def main(estrs_path, meta_scen2_path, ld_path, associatr_path):
    ...
    for chrom in range(1, 23):
        ...
        for cell_type in ['CD4_TCM']:  # to test only
