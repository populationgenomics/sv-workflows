...
def dosages(chromosome,input_gene_list_dir, cis_window_dir, cell_type, pathway):
    ...
    vcf_path = to_path(f'gs://cpg-tenk10k-test/str/associatr/final-freeze/input_files/tr_vcf/v1-chr-specific/hail_filtered_{chromosome}.vcf.bgz')
    vcf_path_index = to_path(f'gs://cpg-tenk10k-test/str/associatr/final-freeze/input_files/tr_vcf/v1-chr-specific/hail_filtered_{chromosome}.vcf.bgz.tbi')
