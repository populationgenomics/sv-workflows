...
TR_PATH = 'gs://cpg-bioheart-test/str/arthur/catalog_in_cis_window.bed'
...
b.write_output(bedtools_job.ofile, 'gs://cpg-bioheart-test/str/arthur/catalog_in_cis_window_intersect.bed')
