...
TR_PATH = 'gs://cpg-bioheart-test/angli/MACS3_Combined_Peaks.bed'
...
b.write_output(bedtools_job.ofile, 'gs://cpg-bioheart-test/angli/arthur/o_files/MACS3_Combined_Peaks_intersect.bed')
