...
def main():
    ...
    mt = hl.read_matrix_table('gs://cpg-bioheart-test/str/wgs_genotyping/polymorphic_run_n2045/annotated_mt/v2/str_annotated.mt')

    # Pull out the 25 samples with LR PacBio data
    samples = hl.import_table('gs://cpg-bioheart-test/str/wgs_genotyping/trgt/mapper_trgt.csv', delimiter=',',key='FS_ID',quote=None,)
    ...
    #extract as a table
    mt.select_entries(mt.sr_summed_rep_length).write('gs://cpg-bioheart-test/str/wgs_genotyping/trgt/sr_rep_lengths.mt', overwrite=True)
