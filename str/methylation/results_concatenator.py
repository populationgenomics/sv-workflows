...
analysis-runner --dataset bioheart --access-level test --output-dir potato --description "Concatenate associatr-methylation results" python3 results_concatenator.py results_concatenator.py
