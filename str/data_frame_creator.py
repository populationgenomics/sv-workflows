...
"""
analysis-runner --access-level test --dataset tob-wgs --description 'data frame creator' --output-dir 'hoptan-str/tob_test_crams/data_frames --input-dir-gangstr=gs://cpg-tob-wgs-test/hoptan-str/tob_test_crams/output_calls/gangstr_0_based  --input-dir-eh=gs://cpg-tob-wgs-test/hoptan-str/tob_test_crams/output_calls/eh_0_based
...
# Initializing Batch
    ...
    b.write_output(eh_csv.as_str(), output_path('eh_0_based.csv'))
    b.write_output(gangstr_csv.as_str(), output_path('gangstr_0_based.tsv'))
