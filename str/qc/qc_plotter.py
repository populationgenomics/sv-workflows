...
def main(mt_path):
    ...
    mt = mt.filter_rows(mt.locus == hl.locus('chr1', 101553423))
    ...
    pq = hl.plot.histogram(alleles_minus_mode_ht.alleles_minus_mode,legend= "Allele sizes minus mode, chr1:101553423")
    output_file('local_plot_pq.html')
    save(pq)
    gcs_path_pq = output_path('alleles_minus_mode/allele_size_chr1_101553423.html', 'analysis')
