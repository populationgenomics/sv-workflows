...
def main(mt_path):
    ...
    mt2 = mt.annotate_entries(
        sum_rep_len = hl.or_missing(
            hl.is_defined(mt.allele_1_rep_length) & hl.is_defined(mt.allele_2_rep_length),
    ...
    global_freq = mt2.aggregate_entries(hl.agg.counter(mt2.sum_rep_len))

    # Optional: turn into a Table for pretty output / export
    global_freq_ht = hl.Table.parallelize(
