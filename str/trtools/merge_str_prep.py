...
For example:
analysis-runner --access-level test --dataset tob-wgs --description 'tester' --output-dir 'str/5M_run_combined_vcfs/merge_str_prep/v2' merge_str_prep.py --caller=eh --input-dir=gs://cpg-tob-wgs-test/hoptan-str --sharded sharded_tester
