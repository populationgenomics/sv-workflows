...
sgdp_metadata = open("sgdp_metadata_mappings.csv") 
...
for i in sgdp_metadata: 
    ...
    if illumina_id in external_sample_ids: 
        ...
        sgdp_id_no_mapping.append(sgdp_id) 
        continue
...
PRJEB9586 = open("filereport_read_run_PRJEB9586_json.txt")
PRJEB9586 = json.load(PRJEB9586)
sample_accessions_to_ingest=[]
external_ids_to_ingest=[]
for i in PRJEB9586: 
    try: 
    ...
    link_1_sample_id = link_1_sample_id_extension[:link_1_extension_length-11]
