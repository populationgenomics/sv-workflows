...
For example:
analysis-runner --access-level test --dataset tob-wgs --description 'gangstr run' --output-dir 'hoptan-str/tob_test_crams/output_calls/gangstr' gangstr_runner_hgdp.py --variant-catalog=gs://cpg-tob-wgs-test/hoptan-str/catalogs/gangstr_pure_repeats_catalog.bed --input-dir=gs://cpg-tob-wgs-test/cram/nagim
