...
analysis-runner --dataset "bioheart" --access-level "test" --description "Patch SNP files" --output-dir "tenk10k/str/associatr/final_freeze/common_variant_snps/tob_n950/results/v2-patch" --memory 16G snp_patch.py \
--chromosomes=chr19 --cell-types=CD4_CTL
"""
