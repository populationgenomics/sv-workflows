...
def sharder(phenotype):
    ...
    gwas_file = f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs/white_british_{phenotype}_snp_str_gwas_results_hg38.tab.gz'
