...
def sharder(phenotype):
    ...
    gwas_file = f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v5/white_british_{phenotype}_snp_str_gwas_results_hg38.tab.gz'
    ...
    for chrom_num in range(1, 23):
        ...
        gwas_chrom.to_csv(
            f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v5/chr-specific/white_british_{phenotype}_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            sep='\t',
            index=False,
        )
