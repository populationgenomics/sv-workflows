...
@click.command()
def main(eqtl_cis_dir, egenes_dir, celltypes, var_annotation_file, pheno):
    ...
    for phenotype in pheno.split(','):
        ...
        for celltype in celltypes.split(','):
            ...
            for gene in result_df_cfm_str_celltype['gene']:
                ...
                str_gwas_subset = str_gwas_subset[~str_gwas_subset['repeat_unit'].isna()]
                ...
                coloc_job = b.new_python_job(
                    f'Coloc for {celltype} and {phenotype}:{gene}',
                )
                coloc_job.cpu(0.25)
