...
def ld_parser(
    ...
    max_corr_master_df.to_csv(
        f'gs://cpg-bioheart-test-analysis/str/associatr/coloc-ld/fm_strs_only/v3-debug/{pheno}/{chrom}/{pheno}_{chrom}_corr.tsv',
        sep='\t',
        index=False,
    )
...
def main(fm_csv, snp_vcf_dir, str_vcf_dir):
    ...
    pheno_list = ['gymrek-ukbb-alanine-aminotransferase']
