...
def main(fm_csv, snp_vcf_dir, str_vcf_dir):
    ...
    for pheno in pheno_list:
        ...
        for chrom in fm_pheno['chr'].unique():
            ...
            'alkaline_phosphatase': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_alkaline_phosphatase_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'apolipoprotein_a': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_apolipoprotein_a_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'apolipoprotein_b': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_apolipoprotein_b_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            ...
            'eosinophil_percent': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_eosinophil_percent_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'gamma_glutamyltransferase': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_gamma_glutamyltransferase_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'glucose': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_glucose_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'glycated_haemoglobin': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_glycated_haemoglobin_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'haematocrit': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_haematocrit_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'haemoglobin_concentration': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_haemoglobin_concentration_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'hdl_cholesterol': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_hdl_cholesterol_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'igf_1': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_igf_1_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'ldl_cholesterol_direct': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_ldl_cholesterol_direct_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'phosphate': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_phosphate_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'shbg': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_shbg_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'total_bilirubin': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_total_bilirubin_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'total_protein': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_total_protein_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            ...
            'mean_corpuscular_haemoglobin': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_mean_corpuscular_haemoglobin_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'mean_corpuscular_haemoglobin_concentration': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_mean_corpuscular_haemoglobin_concentration_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'mean_corpuscular_volume': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_mean_corpuscular_volume_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'mean_platelet_volume': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_mean_platelet_volume_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'mean_sphered_cell_volume': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_mean_sphered_cell_volume_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'neutrophil_count': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_neutrophil_count_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'neutrophil_percent': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_neutrophil_percent_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'platelet_count': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_platelet_count_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'platelet_crit': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_platelet_crit_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'platelet_distribution_width': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_platelet_distribution_width_snp_str_gwas_results_hg38_{chrom}.tab.gz',
            'red_blood_cell_count': f'gs://cpg-bioheart-test/str/gymrek-ukbb-snp-str-gwas-catalogs_v6/chr-specific/white_british_red_blood_cell_count_snp_str_gwas_results_hg38_{chrom}.tab.gz',
