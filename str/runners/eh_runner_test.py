...
For example:
analysis-runner --access-level test --dataset tob-wgs --description 'tester' --output-dir 'tester' eh_runner_test.py --variant-catalog=gs://cpg-tob-wgs-test/hoptan-str/5M_sharded_50k/ --dataset=tob-wgs --sample-id-file=gs://cpg-tob-wgs-test/hoptan-str/CPG308239.csv
    ...
    with to_path(sample_id_file).open() as f:
        ...
        for line in f:
            ...
            crams = b.read_input_group(
                **{
                    'cram': 'gs://cpg-tob-wgs-test/cram/CPG308239.cram',
                    'cram.crai': 'gs://cpg-tob-wgs-test/cram/CPG308239.cram'+ '.crai',
                }
            )
