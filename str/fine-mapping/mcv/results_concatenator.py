...
analysis-runner --dataset tenk10k --access-level test --output-dir str/associatr/final_freeze/fine_mapping/susie_mcv/output_files --description "Concatenate SuSIE results" python3 results_concatenator.py \
...
def main(input_dir, celltypes, pip_prune_threshold):
    ...
    for cell_type in celltypes.split(','):
        ...
        j.call(concatenator, input_dir, cell_type, pip_prune_threshold)
