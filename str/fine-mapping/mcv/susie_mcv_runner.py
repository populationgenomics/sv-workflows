...
analysis-runner --dataset tenk10k --access-level test --memory 8G  --image "australia-southeast1-docker.pkg.dev/cpg-common/images/r-meta:r-fast" --description "Run SusiE MCV" --output-dir str/associatr/final_freeze/fine_mapping/susie_mcv_l1/output_files \
...
--chromosomes=chr1,chr2,chr3,chr4,chr7,chr8,chr9,chr10,chr11,chr12,chr13,chr14,chr15,chr16,chr17,chr18,chr19,chr20,chr21,chr22 --susie-cpu=0.5 --num-causal-variants=1
"""
