"""
This script identifies pure repeat loci (motif 2-6bp) in the Illumina catalog, with no tolerance for indels/SNPs. It then creates left and right flanking sequences of pure repeat loci, which will be used as input
...
for k in orig_catalog_dict:
    ...
    if repeat_count == 1:#ie impure repeat sequence 
        ...
        excluded_loci.append(k)
excluded_loci.append("chr8:49170487-49170547") #manual removal of 2 loci that overlap each other (representing a compound repeat structure)
excluded_loci.append("chr8:49170544-49170552")
