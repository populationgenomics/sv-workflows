...
# provision a new job
bedtools_job = b.new_job(name='Get sequence data for FASTA files')
...
b.write_output(bedtools_job.ofile, output_path('Illumina_catalog_sequences.fasta.txt', 'analysis'))
