...
print(len(flank_catalog_one_motif_length))#989082 lines (ie each of the 164847 loci gets 6 lines)
...
while i<len(flank_catalog_one_motif_length)-5:
    ...
    i+=6
print(len(flank_catalog_one_motif_length_dict)) #164847
...
print(len(flank_catalog_two_motif_lengths))#989082 lines (ie each of the 164847 loci gets 6 lines)

## Dictionary creation of catalog with L/R flanks that are two motif lengths long: 
flank_catalog_two_motif_lengths_dict={} #164847
