...
"""
analysis-runner --access-level test --dataset hgdp --description 'EH data frame creator' --output-dir 'str/sensitivity-analysis/data_frames/untrimmed_coordinates/untrimmed_coordiantes_0_based' data_frame_creator_untrimmed_0_based.py --input-dir-eh=gs://cpg-hgdp-test/str/sensitivity-analysis/eh/untrimmed_coordinates_0_based --input-dir-gangstr=gs://cpg-hgdp-test/str/sensitivity-analysis/gangstr/untrimmed_coordinates
...
# Initializing Batch
    ...
    b.write_output(eh_csv.as_str(), output_path('eh_untrimmed_0_based.csv'))
    b.write_output(gangstr_csv.as_str(), output_path('gangstr_untrimmed_1_based.tsv'))
    b.write_output(merger_csv.as_str(), output_path('merged_dataframe_untrimmed_0_based.csv'))
