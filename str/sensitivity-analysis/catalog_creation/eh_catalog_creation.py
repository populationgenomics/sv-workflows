...
process_variant_catalog("marshfield_regions_gangstr_untrimmed_coordinates.bed", "marshfield_regions_eh_trimmed_coordinates.json")
...
process_variant_catalog("marshfield_regions_eh_trimmed_coordinates.json", "marshfield_regions_gangstr_trimmed.bed")
