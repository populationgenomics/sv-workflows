...
"""
analysis-runner --access-level test --dataset hgdp --description 'data frame creator' --output-dir 'str/sensitivity-analysis/data_frames/untrimmed_coordinates/hg38_backbone_1_based' data_frame_creator_untrimmed_0_based.py --input-dir-eh=gs://cpg-hgdp-test/str/sensitivity-analysis/eh/untrimmed_coordinates_1_based_hg38_backbone --input-dir-gangstr=gs://cpg-hgdp-test/str/sensitivity-analysis/gangstr/untrimmed_coordinates_1_based_hg38_backbone
...
# Initializing Batch
    ...
    b.write_output(eh_csv.as_str(), output_path('hg38_backbone_untrimmed_1_based_eh.csv'))
    b.write_output(gangstr_csv.as_str(), output_path('hg38_backbone_untrimmed_1_based_gangstr.tsv'))
