...
--description "get cis and numpy" --output-dir "str/associatr/gwas-cell-prop/bioheart_n990/input_files" \
 --image "australia-southeast1-docker.pkg.dev/analysis-runner/images/driver:d4922e3062565ff160ac2ed62dcdf2fba576b75a-hail-8f6797b033d2e102575c40166cf0c977e91f834e" \
 get_numpy.py --covariate-file-path=gs://cpg-bioheart-test/str/associatr/bioheart_n990/input_files/bioheart_covariates_str_run_v1.csv \
...
def get_numpy(macrogroup, cov_path, cell_summary_file, remove_samples_file):
    ...
    covariates = pd.read_csv(cov_path)
