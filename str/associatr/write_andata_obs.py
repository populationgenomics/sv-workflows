...
--storage=200G --memory=highmem --cpu=8 \
write_andata_obs.py --input-h5ad-file-path=gs://cpg-bioheart-test/str/240_libraries_tenk10kp1_v2/240_libraries_concatenated_gene_info.h5ad
"""
