...
It aims to:
 ...
 analysis-runner --dataset "tob-wgs" \
    ...
    --image australia-southeast1-docker.pkg.dev/cpg-common/images/cpg_workflows:587e9cf9dc23fe70deb56283d132e37299244209 \
     associatr_runner_part2_chunky.py  --celltypes=CD4_NC_part2,CD8_ET,CD8_NC,NK --chromosomes=chr22
...
def gene_pheno_cov(gene,celltype,chromosomes,ofile_path):

    """Get gene phenotype and covariate numpy objects"""

    pseudobulk = pd.read_csv(output_path(f'input_files/pseudobulk/{celltype}_{chromosomes}_pseudobulk.tsv'), sep='\t')
        ...
        for chromosome in chromosomes.split(','):
            ...
            for gene in pseudobulk_gene_names:
                ...
                gene_pheno_cov_job.call(
                        gene_pheno_cov,gene,celltype, chromosomes, gene_pheno_cov_job.ofile
                    )
