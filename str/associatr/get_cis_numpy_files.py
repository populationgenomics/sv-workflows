...
--description "get cis and numpy" --output-dir "str/associatr/bioheart_n990/input_files"  \
...
def cis_window_numpy_extractor(
    ...
    with to_path(
        output_path(
            f'scRNA_gene_lists/{min_pct}_min_pct_cells_expressed/CD4_TCM_permuted_5/{chromosome}_CD4_TCM_permuted_5_gene_list.json',
        ),
    ...
    for gene in gene_names:
        ...
        ofile_path = output_path(f'cis_window_files/{version}/CD4_TCM_permuted_5/{chromosome}/{gene}_{cis_window}bp.bed')
        ...
        with hl.hadoop_open(
            output_path(f'pheno_cov_numpy/{version}/CD4_TCM_permuted_5/{chromosome}/{gene}_pheno_cov.npy'),
            'wb',
        ) as f:
