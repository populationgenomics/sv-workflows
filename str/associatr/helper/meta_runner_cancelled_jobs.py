...
"""
RUNNING ONLY TO RE-RUN CANCELLED JOBS
...
@click.option('--troubleshoot-file', help='GCS path to the troubleshoot file')
@click.option('--max-parallel-jobs', help='Maximum number of parallel jobs to run', default=500)
@click.command()
def main(results_dir_1, results_dir_2, troubleshoot_file, max_parallel_jobs):
    """
